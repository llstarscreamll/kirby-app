...
describe('EntryAndExitLogFormComponent', () => {
  ...
  describe('check in/out form', () => {
    ...
    it("should NOT set novelty type field as required if time clock data doesn't have novelty types", () => {
      ...
      expect(component.checkForm.get('novelty_type_id').valid).toBe(true);
      expect(component.checkForm.get('novelty_type_id').validator).toBe(null);
      expect(component.checkForm.get('novelty_sub_cost_center').valid).toBe(
        true
      );
      expect(
    ...
    it('should set work shift as selected if there is only one option on time clock data', () => {
      component.timeClockData = earlyTimeClockData;
    ...
    it('should not set as selected the work shift if there is more than one on time clock data', () => {
      component.timeClockData = earlyTimeClockData;
    ...
    it('should have certain form fields when timeClockData is too EARLY for check in', () => {
      component.timeClockData = earlyTimeClockData;
    ...
    it('should have certain form fields when timeClockData is too EARLY for check out', () => {
      component.timeClockData = earlyTimeClockData;
      component.timeClockData.action = 'check_out';
    ...
    it('should have certain form fields when timeClockData is too LATE for check in', () => {
      component.timeClockData = earlyTimeClockData;
    ...
    it('should have certain form fields when timeClockData is too LATE for check out', () => {
      component.timeClockData = earlyTimeClockData;
      component.timeClockData.punctuality = 1; // too late
      component.timeClockData.action = 'check_out';
      component.timeClockData.novelty_types[0].name = 'Test novelty';
