...
describe('ResumeByEmployeesAndNoveltyTypesPageComponent', () => {
  ...
  it('should call novelties facade methods on init', () => {
    ...
    expect(noveltiesFacade.getResumeByEmployeesAndNoveltyTypes).toHaveBeenCalledWith({
  ...
  it('should have certain elements by default', () => {
    ...
    expect(fixture.nativeElement.querySelector('kirby-resume-by-employees-and-novelty-types-table')).toBeFalsy();
    expect(fixture.nativeElement.querySelector('kirby-resume-by-employees-and-novelty-types-table')).toBeFalsy();
  });
  ...
  it('should show resume table and page navigation when paginatedResume$ is ready', () => {
    ...
    expect(fixture.nativeElement.querySelector('kirby-resume-by-employees-and-novelty-types-table')).toBeTruthy();

    expect(fixture.nativeElement.querySelector('kirby-pagination')).toBeTruthy();
  ...
  describe('search form', () => {
    it('should have certain fields', () => {
      expect(template.querySelector('form [formControlName="search"]')).toBeTruthy();
      expect(template.querySelector('form [formControlName="start_date"]')).toBeTruthy();
      expect(template.querySelector('form [formControlName="end_date"]')).toBeTruthy();
