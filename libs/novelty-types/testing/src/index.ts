...
import { NoveltyTypeInterface, DayType, NoveltyTypeOperator } from '@kirby/novelty-types/data';

export function createNoveltyType(
  id?: string,
  attrs = {}
  ...
  return NoveltyTypeInterface.fromJson({
